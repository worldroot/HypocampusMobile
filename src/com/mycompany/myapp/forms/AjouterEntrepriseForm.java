 ...
 * @author Houcem
 */
public class AjouterEntrepriseForm extends BaseForm {
	
	public AjouterEntrepriseForm(Form previous,Resources res) {
		super("ajouter un Entreprise", BoxLayout.y());
        
        Toolbar tb = new Toolbar(true);
        setToolbar(tb);
        getTitleArea().setUIID("Container");
        setTitle("ajouter un Entreprise");
        ...
        twitter.setTextPosition(BOTTOM);
         ...
         Container c = new Container(new BoxLayout(BoxLayout.Y_AXIS));
            ...
            TextField tfTeamname = new TextField("", " name");
