 ...
 * @author Houcem
 */
public class EntrepriseForm extends BaseForm {
	
	ComboBox<Entreprise> Combo;

	EntrepriseForm(Form previous, Resources res) {
		...
		fab.addActionListener((ActionListener) (ActionEvent evt1) -> {
              ...
              new AjouterEntrepriseForm(this,res).show();
        ...
        for (Entreprise T :  sp.getAllTeams()) {
	 ...
	 public void addItem(Entreprise T,Resources res) {

        
        Container C = new Container(new BoxLayout(BoxLayout.Y_AXIS));
		Container C1 = new Container(new BoxLayout(BoxLayout.X_AXIS));
        Label teamname = new Label("Name : "+T.getName());
		Label email = new Label("email : "+T.getEmail());
        Label date = new Label("Date of creatiion : "+T.getCreatedate());
 ...
 //Graphic
  ...
  Font f = Font.createSystemFont(Font.FACE_PROPORTIONAL, Font.STYLE_ITALIC, Font.SIZE_MEDIUM);
	...
	ServiceEntreprise s=new ServiceEntreprise();
        ...
        Dialog.show("Succès", "L' Entreprise a été supprimé avec succès", "OK", null);
		    new EntrepriseForm(this, res).show();
        });
		 edit.addPointerPressedListener((ActionListener) (ActionEvent evt) -> {
			new ModifierEntrepriseForm(this, res, T).show();
        });
