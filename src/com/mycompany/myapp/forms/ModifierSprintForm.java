 ...
 * @author 21694
 */
public class ModifierSprintForm extends  BaseForm {

    public ModifierSprintForm(Form previous,Resources res ,Sprint SprintT,Project project_)  {
 super("ajouter un projet", BoxLayout.y());
        ...
        twitter.setTextPosition(BOTTOM);
         ...
         Container c = new Container(new BoxLayout(BoxLayout.Y_AXIS));
            ...
            TextField name = new TextField("",SprintT.getName());
            Label start_date_L = new Label("  "+"Date de début : ");
            Picker start_date = new Picker();
            start_date.setDate(SprintT.getStart_date_sprint());
            Label end_date_L = new Label("  "+"Date fin : ");
            Picker end_date = new Picker();
            end_date.setDate(SprintT.getEnd_date_sprint());
          ...
          // Date dateS=start_date.getDate();//converting string into sql date
           ...
           String b=end_date.getDate().toString();
            System.out.println(b);
                ...
                Sprint p=new Sprint(name.getText(),start_date.getDate(),end_date.getDate());
                ...
                sp.updateSprint(p,SprintT.getId());
